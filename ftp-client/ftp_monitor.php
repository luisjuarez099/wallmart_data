...
while (true) {
    ...
    if (ftp_size($ftp, FTP_RMTE) != -1) {   
        ...
        // download file
        if (ftp_get($ftp, FTP_LCAL, FTP_RMTE, FTP_BINARY)) {
            ...
            //unlink("/opt/lampp/htdocs/UNEDL_PIV_2023A/phpWalmart/ftp-client/".FTP_LCAL);
            unlink("/opt/lampp/htdocs/UNEDL_PIV_2023A/phpWalmart/ftp-server/".FTP_RMTE);
        }
        else
